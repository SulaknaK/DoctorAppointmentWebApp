...
function TopDoctors() {
  ...
  return (
    <div className='flex flex-col utems-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <button onClick={()=> {navigate('/doctors'); scroll(0,0)}} className='bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10'>more</button>
    </div>
  )
}
